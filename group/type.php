...
<div id="ct" class="ct2 wp cl">
	...
	<div class="bm fl cl">
		...
		<!--{if $typelist}-->
			<div class="bm_c pbm ptm bbs ggq-qzfl cl">
				<!--{loop $typelist $fid $type}--><a href="group.php?sgid=$fid">$type[name]<!--{if $type[groupnum]}--><span class="xg1">$type[groupnum]</span><!--{/if}--></a><!--{/loop}-->
			</div>
		<!--{/if}-->
		<!--{hook/index_top}-->
		<!--{if $list}-->
