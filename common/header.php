...
<!--{subtemplate common/header_common}-->
	...
	<!--{/if}-->
	<script src="template/guiigo_qing/js/jquery.min.js"></script>
	<script src="template/guiigo_qing/js/focus.js" type="text/javascript"></script>
	<script src="template/guiigo_qing/js/owl.carousel.js"></script>
	<script src="template/guiigo_qing/js/jquery.SuperSlide.js"></script>
</head>
		...
		<!--{if !IS_ROBOT}-->
			...
			<ul id="myprompt_menu" class="p_pop" style="display: none;">
				...
				<!--{if empty($_G['cookie']['ignore_notice'])}-->
					<li class="ignore_noticeli"><a href="javascript:;" onclick="setcookie('ignore_notice', 1);hideMenu('myprompt_menu')" title="{lang temporarily_to_remind}"><em class="ignore_notice"></em>{lang temporarily_to_remind}</a></li>
				<!--{/if}-->
			</ul>
			<!--{/if}-->
